...
public abstract class CustomOption<A> implements Iterable<A>, Serializable {
	 ...
	 */
	public static <A> F<CustomOption<A>, Boolean> isSome_() {
		return new F<CustomOption<A>, Boolean>() {
			public Boolean f(final CustomOption<A> a) {
				return a.isSome();
			}
		};
	}
	 ...
	 */
	public static <A> F<CustomOption<A>, Boolean> isNone_() {
		return new F<CustomOption<A>, Boolean>() {
			public Boolean f(final CustomOption<A> a) {
				return a.isNone();
			}
	 ...
	 */
	public final <B> CustomOption<B> map(final F<A, B> f) {
		return isSome() ? some(f.f(some())) : CustomOption.<B>none();
	}
	 ...
	 */
	public static <A, B> F<F<A, B>, F<CustomOption<A>, CustomOption<B>>> map() {
		return curry(new F2<F<A, B>, CustomOption<A>, CustomOption<B>>() {
			public CustomOption<B> f(final F<A, B> abf, final CustomOption<A> option) {
	 ...
	 */
	public final CustomOption<A> filter(final F<A, Boolean> f) {
		return isSome() ? f.f(some()) ? this : CustomOption.<A>none() : CustomOption.<A>none();
	}
	 ...
	 */
	public final <B> CustomOption<B> bind(final F<A, CustomOption<B>> f) {
		return isSome() ? f.f(some()) : CustomOption.<B>none();
	}
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C> CustomOption<C> bind(final CustomOption<B> ob, final F<A, F<B, C>> f) {
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D> CustomOption<D> bind(final CustomOption<B> ob, final CustomOption<C> oc, final F<A, F<B, F<C, D>>> f) {
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E> CustomOption<E> bind(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$> CustomOption<F$> bind(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
												  final CustomOption<E> oe, final F<A, F<B, F<C, F<D, F<E, F$>>>>> f) {
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G> CustomOption<G> bind(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
													final CustomOption<E> oe, final CustomOption<F$> of,
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G, H> CustomOption<H> bind(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
													   final CustomOption<E> oe, final CustomOption<F$> of, final CustomOption<G> og,
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G, H, I> CustomOption<I> bind(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
														  final CustomOption<E> oe, final CustomOption<F$> of, final CustomOption<G> og,
														  final CustomOption<H> oh,
														  final F<A, F<B, F<C, F<D, F<E, F<F$, F<G, F<H, I>>>>>>>> f) {
		return oh.apply(bind(ob, oc, od, oe, of, og, f));
	}

	public final <B> CustomOption<P2<A,B>> bindProduct(final CustomOption<B> ob) {
		return bind(ob, P.<A,B>p2());
	}

	public final <B, C> CustomOption<P3<A,B,C>> bindProduct(final CustomOption<B> ob, final CustomOption<C> oc) {
		return bind(ob, oc, P.<A,B,C>p3());
	}

	public final <B, C, D> CustomOption<P4<A,B,C,D>> bindProduct(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od) {
		return bind(ob, oc, od, P.<A, B, C, D>p4());
	}

	public final <B,C,D,E> CustomOption<P5<A,B,C,D,E>> bindProduct(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
															 final CustomOption<E> oe) {
		return bind(ob, oc, od, oe, P.<A, B, C, D, E>p5());
	}

	public final <B,C,D,E,F$> CustomOption<P6<A,B,C,D,E,F$>> bindProduct(final CustomOption<B> ob, final CustomOption<C> oc, final CustomOption<D> od,
																   final CustomOption<E> oe, final CustomOption<F$> of) {
		return bind(ob, oc, od, oe, of, P.<A, B, C, D, E, F$>p6());
	}

	public final <B,C,D,E,F$,G> CustomOption<P7<A,B,C,D,E,F$,G>> bindProduct(final CustomOption<B> ob, final CustomOption<C> oc,
																	   final CustomOption<D> od, final CustomOption<E> oe,
																	   final CustomOption<F$> of, final CustomOption<G> og) {
		return bind(ob, oc, od, oe, of, og, P.<A, B, C, D, E, F$, G>p7());
	}

	public final <B,C,D,E,F$,G,H> CustomOption<P8<A,B,C,D,E,F$,G,H>> bindProduct(final CustomOption<B> ob, final CustomOption<C> oc,
																		   final CustomOption<D> od, final CustomOption<E> oe,
																		   final CustomOption<F$> of, final CustomOption<G> og,
																		   final CustomOption<H> oh) {
	 ...
	 */
	public final <B> CustomOption<B> sequence(final CustomOption<B> o) {
		final F<A, CustomOption<B>> c = constant(o);
		return bind(c);
	}
	 ...
	 *         optional value.
	 */
	public final <B> CustomOption<B> apply(final CustomOption<F<A, B>> of) {
		return of.bind(new F<F<A, B>, CustomOption<B>>() {
			public CustomOption<B> f(final F<A, B> f) {
	 ...
	 */
	public final CustomOption<A> orElse(final P1<CustomOption<A>> o) {
	 ...
	 * @return This optional value if there is one, otherwise, returns the argument optional value.
	 */
	public final CustomOption<A> orElse(final CustomOption<A> o) {
	 ...
	 *         return in left.
	 */
	public static <A, X> F<CustomOption<A>, F<X, Either<X, A>>> toEither() {
		return curry(new F2<CustomOption<A>, X, Either<X, A>>() {
			public Either<X, A> f(final CustomOption<A> a, final X x) {
				return a.toEither(x);
			}
		});
	}
	...
	private static final class None<A> extends CustomOption<A> {
		public A some() {
	...
	private static final class Some<A> extends CustomOption<A> {
		private final A a;
	...
	public static <T> F<T, CustomOption<T>> some_() {
		return new F<T, CustomOption<T>>() {
			public CustomOption<T> f(final T t) {
				return some(t);
			}
		};
	}
	 ...
	 */
	public static <T> CustomOption<T> some(final T t) {
		return new Some<T>(t);
	}
	 ...
	 */
	public static <T> CustomOption<T> none() {
		return new None<T>();
	}
	 ...
	 */
	public static <T> CustomOption<T> fromNull(final T t) {
		return t == null ? CustomOption.<T>none() : some(t);
	}
	 ...
	 * @return If <code>t == null</code> then return it in some, otherwise, return none.
	 */
	public static <T> F<T, CustomOption<T>> fromNull() {
		return new F<T, CustomOption<T>>() {
			public CustomOption<T> f(final T t) {
				return fromNull(t);
			}
	 ...
	 */
	public static <A> CustomOption<A> join(final CustomOption<CustomOption<A>> o) {
		final F<CustomOption<A>, CustomOption<A>> id = identity();
		return o.bind(id);
	}
	 ...
	 */
	public static <A> CustomOption<List<A>> sequence(final List<CustomOption<A>> a) {
		return a.isEmpty() ?
			some(List.<A>nil()) :
			a.head().bind(new F<A, CustomOption<List<A>>>() {
				public CustomOption<List<A>> f(final A aa) {
	 ...
	 *         on that argument, otherwise, returns no value.
	 */
	public static <A> CustomOption<A> iif(final F<A, Boolean> f, final A a) {
		return f.f(a) ? some(a) : CustomOption.<A>none();
	}
	 ...
	 *         no value.
	 */
	public static <A> CustomOption<A> iif(final boolean p, final P1<A> a) {
		return p ? some(a._1()) : CustomOption.<A>none();
	}
	 ...
	 *         no value.
	 */
	public static <A> CustomOption<A> iif(final boolean p, final A a) {
		return iif(p, p(a));
	}
	 ...
	 */
	public static <A> F2<F<A, Boolean>, A, CustomOption<A>> iif() {
		return new F2<F<A, Boolean>, A, CustomOption<A>>() {
			public CustomOption<A> f(final F<A, Boolean> p, final A a) {
				return iif(p, a);
			}
		};
	}
	 ...
	 */
	public static <A> List<A> somes(final List<CustomOption<A>> as) {
		return as.filter(CustomOption.<A>isSome_()).map(new F<CustomOption<A>, A>() {
			public A f(final CustomOption<A> o) {
				return o.some();
			}
		});
	}
	 ...
	 */
	public static <A> Stream<A> somes(final Stream<CustomOption<A>> as) {
		return as.filter(CustomOption.<A>isSome_()).map(new F<CustomOption<A>, A>() {
			public A f(final CustomOption<A> o) {
				return o.some();
			}
	 ...
	 */
	public static CustomOption<String> fromString(final String s) {
		return fromNull(s).bind(new F<String, CustomOption<String>>() {
			public CustomOption<String> f(final String s) {
				final CustomOption<String> none = none();
	 ...
	 *         or no value if the string is empty.
	 */
	public static F<String, CustomOption<String>> fromString() {
		return new F<String, CustomOption<String>>() {
			public CustomOption<String> f(final String s) {
				return fromString(s);
			}
		};
	 ...
	 */
	public static <A> F<CustomOption<A>, A> fromSome() {
		return new F<CustomOption<A>, A>() {
			public A f(final CustomOption<A> option) {
				return option.some();
			}
		};
	}
	 ...
	 */
	public static <A, B, C> F<CustomOption<A>, F<CustomOption<B>, CustomOption<C>>> liftM2(final F<A, F<B, C>> f) {
		return curry(new F2<CustomOption<A>, CustomOption<B>, CustomOption<C>>() {
			public CustomOption<C> f(final CustomOption<A> a, final CustomOption<B> b) {
				return a.bind(b, f);
			}
		});
	}
	 ...
	 */
	public static <A, B> F<F<A, CustomOption<B>>, F<CustomOption<A>, CustomOption<B>>> bind() {
		return curry(new F2<F<A, CustomOption<B>>, CustomOption<A>, CustomOption<B>>() {
			public CustomOption<B> f(final F<A, CustomOption<B>> f, final CustomOption<A> a) {
				return a.bind(f);
			}
		});
	}
	 ...
	 */
	public static <A> F<CustomOption<CustomOption<A>>, CustomOption<A>> join() {
		return new F<CustomOption<CustomOption<A>>, CustomOption<A>>() {
			public CustomOption<A> f(final CustomOption<CustomOption<A>> option) {
				return join(option);
			}
		};
	}
